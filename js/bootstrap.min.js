...
+ function (a) {
    ...
    if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1 || b[0] > 3) 
        throw new Error(
            "Bootstrap's JavaScript requires jQuery version 1.9.1 or higher, but lower than" +
            " version 4"
        )
}(jQuery), + function (a) {
    "use strict";
    ...
    var d = function (b, c) {
        ...
        this.$trigger = a(
            '[data-toggle="collapse"][href="#' + b.id + '"],[data-toggle="collapse"][data-t' +
            'arget="#' + b.id + '"]'
        ),
    ...
    function c(c) {
        c && 3 === c.which || (a(e).remove(), a(f).each(function () {
            ...
            e.hasClass("open") && (
                c && "click" == c.type && /input|textarea/i.test(c.target.tagName) && a.contains(e[0], c.target) || (e.trigger(c = a.Event("hide.bs.dropdown", f)), c.isDefaultPrevented() || (
    ...
    b.prototype.process = function () {
        ...
        if (g && b < e[0]) 
            ...
            this.clear();
        for (a = e.length; a--;) 
            g != f[a] && b >= e[a] && (void 0 === e[a + 1] || b < e[a + 1]) && this.activate(
                f[a]
            )
    },
